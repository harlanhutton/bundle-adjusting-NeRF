...
class Model(base.Model):
    ...
    def generate_warp_perturbation(self,opt):
        ...
        print('WARP PERT ALL: ', warp_pert_all)
        print('WARP PERT ALL SHAPE: ', warp_pert_all.shape)
        print('IMAGE PERT ALL: ', image_pert_all)
        print('IMAGE PERT ALL SHAPE: ', image_pert_all.shape)
